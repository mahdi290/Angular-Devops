...
@Component({
  selector: 'app-commandetous',
  templateUrl: './commandetous.component.html',
  styleUrls: ['./commandetous.component.css']
  
})
export class CommandetousComponent {
  ...
  goToCommandDetails(id:number): void {
        ...
        // Once you have the service details, navigate to the commanddetails component
        console.log(id)
